package com.janus.myweb.sys.dao.impl;
...
import com.janus.myweb.sys.domain.vo.SysDictionaryVo;
import com.janus.myweb.sys.enums.EnumDictionaryType;
import com.janus.myweb.sys.enums.EnumStatus;
...
public class SysDictionaryDaoImplTest {
    ...
    public void testSelectPageList() {
        ...
        dicQ.setDicNameLike("name");
        Pageable page = new PageRequest(1, 5, Direction.ASC, "dicOrder");
        Page<SysDictionaryVo> dicVoPage = sysDictionaryDao.selectPageList(dicQ,
                page);
    ...
    public void testSelectMap() {
        ...
        Map<String, SysDictionaryVo> dicVoMap = sysDictionaryDao.selectMap(
                dicQ, "dicId", page);
