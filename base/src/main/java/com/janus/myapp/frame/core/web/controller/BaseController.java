package com.janus.myapp.frame.core.web.controller;

import org.springframework.data.domain.Pageable;
import org.springframework.web.servlet.ModelAndView;

import com.janus.myapp.frame.core.domain.Identifiable;
import com.janus.myapp.frame.core.web.vo.Result;

public interface BaseController<T extends Identifiable, Q extends T> {
    /**
     * 根据ID列表删除对象，如果idList 为空或者空列表则直接返回{@link Result},状态为OK <blockquote>
    ...
    /**
     * 跳转到添加页面为insertXXX页面<br>
     * 示例Bean对象:SysDictionay->生成路径：/sys/dictionary <blockquote>
     * <table cellpadding=1 border=1 cellspacing=0 summary="Capturing group numberings">
     * <tr>
     * <th><tt>路径&nbsp;&nbsp;&nbsp;&nbsp;</tt></th>
     * <th>访问方式&nbsp;&nbsp;&nbsp;&nbsp;</th>
    ...
    /**
     * 查询对象列表，返回页面 listXXX页面 <blockquote>
     * <table cellpadding=1 border=1 cellspacing=0 summary="Capturing group numberings">
     * <tr>
     * <th><tt>路径&nbsp;&nbsp;&nbsp;&nbsp;</tt></th>
     * <th>访问方式&nbsp;&nbsp;&nbsp;&nbsp;</th>
    ...
    /**
     * 根据ID查询一个对象，返回页面为viewXXX页面 <blockquote>
     * <table cellpadding=1 border=1 cellspacing=0 summary="Capturing group numberings">
     * <tr>
     * <th><tt>路径&nbsp;&nbsp;&nbsp;&nbsp;</tt></th>
     * <th>访问方式&nbsp;&nbsp;&nbsp;&nbsp;</th>
