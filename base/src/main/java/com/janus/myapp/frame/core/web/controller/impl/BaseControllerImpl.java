package com.janus.myapp.frame.core.web.controller.impl;
...
import com.janus.myapp.frame.core.web.controller.BaseController;
import com.janus.myapp.frame.core.web.vo.ControllerPath;
import com.janus.myapp.frame.core.web.vo.Result;
import com.janus.myapp.frame.core.web.vo.Result.Status;

public abstract class BaseControllerImpl<T extends Identifiable, Q extends T>
        implements BaseController<T, Q> {
    private Logger           log  = LoggerFactory
                                          .getLogger(BaseControllerImpl.class);
    /**
     * @fields path 页面路径信息
     */
